...
public class NotationQueueTest {
	...
	public void testDequeueStudent() {
		try {
			assertEquals(6.0, doubleQ.dequeue(), 0.01);
			assertEquals(7.3, doubleQ.dequeue(), 0.01);
			assertEquals(999.98, doubleQ.dequeue(), 0.01);
			assertEquals(14.0, doubleQ.dequeue(), 0.01);
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleQ.dequeue();
			assertTrue("This should have caused an QueueUnderflowException", false);
		}
	...
	public void testEnqueueStudent() {
		try {
			...
			assertEquals(true, doubleQ.enqueue(100.9867059));
			assertEquals(5, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(6646.999));
	...
	public void testToStringStudent() {
		try {
			assertEquals("6.07.3999.9814.0", doubleQ.toString());
			doubleQ.enqueue(2.0);
			assertEquals("6.07.3999.9814.02.0", doubleQ.toString());
		}catch(QueueOverflowException e) {
			e.printStackTrace();
		}
	}
