...
public class NotationStackTest {
	...
	public void testPopStudent() {
		try {
			...
			assertEquals(8.0, doubleS.pop(), 0.01);
			assertEquals(7.0, doubleS.pop(), 0.01);
			assertEquals(6.0, doubleS.pop(), 0.01);
	...
	public void testPushStudent() {
		try {
			...
			assertEquals(true, doubleS.push(14.0));
			assertEquals(5, doubleS.size());
			assertEquals(true, doubleS.push(15.9));
	...
	public void testToStringStudent() {
		try {
			assertEquals("6.07.08.09.0", doubleS.toString());
			doubleS.push(10.0);
			assertEquals("6.07.08.09.010.0", doubleS.toString());
		}catch(StackOverflowException e) {
			e.printStackTrace();
		}
	}
